...
//            BigDecimal updatedHistoricalTotalSpent = historicalSpent.add(totalValue).subtract(walletAmount);
//
//            user.setHistoricalTotalSpent(updatedHistoricalTotalSpent);
//            user.setWalletAmount(BigDecimal.valueOf(0));
//
//            Wallet wallet = walletRepository.findByTotalValue(updatedHistoricalTotalSpent);
//
//            BigDecimal discountFraction = BigDecimal.valueOf(wallet.getDiscountFraction()/100);
//            BigDecimal totalValueAfterDiscount = totalValue.subtract(walletAmount);
//            BigDecimal discount = totalValueAfterDiscount.multiply(discountFraction);
